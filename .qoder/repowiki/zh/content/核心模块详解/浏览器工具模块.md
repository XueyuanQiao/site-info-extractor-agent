...
## 更新摘要
**变更内容**
- 新增完整的 Playwright 集成，实现异步浏览器自动化
- 增强异步上下文管理器支持，提供更好的资源管理
- 实现无头模式配置，支持灵活的浏览器运行模式
- 完善页面内容抓取功能，包括标题、内容、文本和元数据提取
- 建立与 LangChain 生态系统的深度集成架构
...
**更新** 新增完整的 Playwright 集成，实现异步浏览器自动化功能，包括无头模式支持、页面内容抓取和元数据提取等核心能力。
...
- [extractor_agent.py](file://src/agents/extractor_agent.py#L1-L352)
...
**图表来源**
- [extractor_agent.py](file://src/agents/extractor_agent.py#L90-L352)
- [browser_tool.py](file://src/tools/browser_tool.py#L10-L108)
...
**图表来源**
- [extractor_agent.py](file://src/agents/extractor_agent.py#L244-L352)
...
**更新** 新增 Playwright 依赖，版本要求为 >=1.48.0。
...
**更新** 新增 Playwright 集成带来的性能提升和功能增强，包括异步上下文管理器的资源管理优势。
...
**更新** 新增异步上下文管理器的使用示例，提供更好的资源管理体验。
